discard """
  ...
  nimout: '''
tsigmatch.nim(126, 4) Error: type mismatch: got <A, string>
but expected one of:
proc f(a: A)
...
tsigmatch.nim(140, 6) Error: type mismatch: got <(string, proc (){.gcsafe.})>
but expected one of:
...
tsigmatch.nim(147, 11) Error: type mismatch: got <proc (s: string): string{.noSideEffect, gcsafe.}>
but expected one of:
...
expression: foo(fun)
tsigmatch.nim(158, 13) Error: type mismatch: got <array[0..0, proc (x: int){.gcsafe.}]>
but expected one of:
...
tsigmatch.nim(164, 4) Error: type mismatch: got <int literal(10), a0: int literal(5), string>
but expected one of:
...
tsigmatch.nim(171, 4) Error: type mismatch: got <string, string, string, string, string, float64, string>
but expected one of:
...
tsigmatch.nim(179, 4) Error: type mismatch: got <string, a0: int literal(12)>
but expected one of:
...
tsigmatch.nim(186, 7) Error: type mismatch: got <Mystring, string>
but expected one of:
